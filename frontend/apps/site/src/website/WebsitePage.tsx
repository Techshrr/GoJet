...
export function WebsitePage({pathname}:{pathname:string}){
  ...
  const {page,locale}=match; const copy=locale==='en'?page.en:page.zh; const canonical=locale==='en'?page.path:page.zhPath;
  ...
  return <WebsiteShell locale={locale}><article className="website-page" data-route-id={page.routeId} data-locale={locale}>
