...
var (
	...
	ErrWorkspacePermissionRequired = errors.New("custom-domain workspace manage permission required")
	...
	ErrHTTPSRequired             = errors.New("custom-domain active HTTPS required")
	ErrDomainSecuritySuspended   = errors.New("custom-domain security suspension active")
	...
	ErrDomainRiskEvaluation      = errors.New("custom-domain risk evaluation failed")
)
