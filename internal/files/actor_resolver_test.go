...
func TestFilesActorResolverPrefersServerAuthorityOverTestHeaders(t *testing.T) {
...
func TestFilesActorResolverPreservesViewerReadOnly(t *testing.T) {
...
func TestFilesActorResolverAllowsViewerRead(t *testing.T) {
	api := &API{actorResolver: func(*http.Request, string) (Actor, error) {
		return Actor{ActorID: "real-user", Role: "viewer"}, nil
	}}
	req := httptest.NewRequest(http.MethodGet, "/api/workspaces/real-workspace/files", nil)
	recorder := httptest.NewRecorder()
...
func TestFilesActorResolverMapsAuthorityErrors(t *testing.T) {
	tests := []struct {
		name string
		err  error
		want int
...
func TestFilesActorResolverRejectsUnknownRole(t *testing.T) {
	api := &API{actorResolver: func(*http.Request, string) (Actor, error) {
