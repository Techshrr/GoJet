...
func TestTextActorResolverPrefersServerAuthorityOverTestHeaders(t *testing.T) {
...
func TestTextActorResolverPreservesViewerReadOnly(t *testing.T) {
...
func TestTextActorResolverAllowsViewerRead(t *testing.T) {
	api := &API{actorResolver: func(*http.Request, string) (Actor, error) {
		return Actor{ActorID: "real-user", Role: "viewer"}, nil
	}}
	req := httptest.NewRequest(http.MethodGet, "/api/workspaces/real-workspace/text-shares", nil)
	recorder := httptest.NewRecorder()
...
func TestTextActorResolverMapsAuthorityErrors(t *testing.T) {
	tests := []struct {
		name string
		err  error
		want int
...
func TestTextActorResolverRejectsUnknownRole(t *testing.T) {
	api := &API{actorResolver: func(*http.Request, string) (Actor, error) {
