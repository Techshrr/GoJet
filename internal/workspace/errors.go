...
var (
	...
	ErrAuthenticationRequired    = errors.New("workspace authentication required")
	ErrAuthenticationUnavailable = errors.New("workspace authentication dependency unavailable")
)
