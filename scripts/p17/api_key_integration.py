...
CASE_CONFIG = {
    "P17-T022": {
        "evidence": "artifacts/v10/P17/api-keys/P17-T022.json",
        "case_source": "scripts/p17/api_key_case_runner/t022.go",
        "environment": "real MySQL 8.x plus real Redis 7.x using production Workspace API-key create/scope/secret-once authority",
    },
    "P17-T023": {
        "evidence": "artifacts/v10/P17/api-keys/P17-T023.json",
        "case_source": "scripts/p17/api_key_case_runner/t023.go",
        "environment": "real MySQL 8.x plus real Redis 7.x using production API-key rotate/revoke/expiry/scope/rate lifecycle authority",
    },
    "P17-T024": {
        "evidence": "artifacts/v10/P17/api-keys/P17-T024.json",
        "case_source": "scripts/p17/api_key_case_runner/t024.go",
        "environment": "real MySQL 8.x plus real Redis 7.x using production Workspace tenant and server-side RBAC isolation authority",
    },
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="GoJet V10 P17 real Workspace API-key governance evidence driver")
...
def main() -> int:
    ...
    if config is None:
        fail(f"P17 API-key integration case is not implemented at this stage: {args.case}")
    ...
    proc = run("go", "run", "./scripts/p17/api_key_case_runner", "--case", args.case, check=False)
    ...
    source_paths = {
        "api_key_migration": "migrations/000028_workspace_api_keys.sql",
        "api_key_authority": "internal/admin/api_keys.go",
        "api_key_http": "internal/admin/http_api_keys.go",
        "api_key_unit_tests": "internal/admin/api_keys_test.go",
        "platform_admin_mount": "services/platformapi/cmd/server/admin_access.go",
        "runner_main": "scripts/p17/api_key_case_runner/main.go",
        "runner_helpers": "scripts/p17/api_key_case_runner/helpers.go",
        "case_runner": str(config["case_source"]),
        "integration_router": "scripts/p17/integration.py",
        "api_key_evidence_driver": "scripts/p17/api_key_integration.py",
        "legacy_evidence_driver": "scripts/p17/integration_t001_t021.py",
    ...
    if leaked:
        ...
        evidence["evidence_policy"]["raw_api_key_secret_present"] = "gak_" in leaked
